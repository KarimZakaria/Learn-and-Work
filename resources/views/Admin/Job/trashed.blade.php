...
@section('content')
    ...
    <div class="card card-default">
        ...
        <h4 class="card-header text-center">All Trashed Jobs </h4>
                    ...
                    @forelse ($trashed as $trash)  
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" scope="row">{{$trash->job_name}}</th>
                                    <th class="text-center" scope="row">
                                        <a href="{{ route('Admin.Job.Restore' , $trash->id) }}" class="btn btn-primary btn-sm">Restore</a>
                                        <a href="{{ route('Admin.Job.destroy' , $trash->id) }}" class="btn btn-danger btn-sm">Delete</a>    
                                    </th>
                                </tr>
                            @empty
                                <h3 class="text-center text-danger"> No Trashed Jobs Yet !</h3>
                            @endforelse

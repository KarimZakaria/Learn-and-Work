...
@section('content')
    ...
    <div class="card card-default">
        ...
        <h4 class="card-header text-center">All Trashed Category </h4>
                ...
                <table  class="table table-striped table-bordered bg-dark text-white" >
                    @forelse ($trashed as $trash)  
                        ...
                        <tr>
                            ...
                            <th class="text-center text-danger" scope="col"> Category Name </th>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" scope="row">
                                        <a href="{{ route('Admin.Category.Restore' , $trash->id) }}" class="btn btn-primary btn-sm">Restore</a>
                                        <a href="{{ route('Admin.Category.destroy' , $trash->id) }}" class="btn btn-danger btn-sm">Delete</a>    
                                    </th>
                                </tr>
                            @empty
                                <h3 class="text-center text-danger"> No Trashed Category Yet !</h3>
                            @endforelse
